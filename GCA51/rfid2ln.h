/*****************************************************************************
 * This rfid2ln lib was adapted from https://github.com/lmmeng/rfid2ln
 * to compile in Arduino IDE for the GCA51 sketch.
 *
 * ----------------------------------------------------------------------------
...
extern void buildLnMessage(MFRC522 mfrc522, uint8_t uiRfidPort, uint8_t uiBufWrIdx);
